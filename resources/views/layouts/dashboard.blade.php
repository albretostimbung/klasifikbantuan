...
<body class="bg-[#FAFAFA]">
    <!-- Mobile Menu Toggle -->
    <button id="toggleSidebar" class="fixed top-4 left-4 z-[1000] lg:hidden">
    ...
    <script>
        ...
        document.getElementById('toggleCloseSidebar').addEventListener('click', function(e) {
            e.preventDefault();
            const sidebar = document.getElementById('sidebarHRIS');
